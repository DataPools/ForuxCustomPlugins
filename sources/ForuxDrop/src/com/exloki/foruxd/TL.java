...
public enum TL {
    ...
    ER_DROP_TOO_HIGH("error-drop_too_high", "&4Error&f: You cannot call in an air drop above Y: 250!"),
    ER_DROP_IN_FACTION_LAND("error-drop_in_faction_land", "&4Error&f: You cannot call in an air drop in Faction territory"),
    ER_DROP_IN_WORLD_GUARD("error-drop_in_world_guard", "&4Error&f: You cannot call in an air drop in a WorldGuard region"),
    ER_DROP_AREA_NOT_CLEAR("error-drop_area_not_clear", "&4Error&f: The path for the air drop is not clear!"),
    ER_DROP_NOT_GROUNDED("error-drop_not_grounded", "&4Error&f: You must call in your air drop on the ground!"),

    ER_CANNOT_AFFORD_DROP("error-cannot_afford_drop", "&4Error&f: You cannot afford this!"),

    OPENING_GUI("opening_gui", "&7&oOpening drop menu..."),
    AIR_DROP_IBNOUND("air_drop_incoming", "&6Your air drop has been ordered and is on the way!")
