...
import com.exloki.balancedfly.BalancedFlyMain;
import com.exloki.balancedfly.Msg;
import com.exloki.balancedfly.core.utils.BukkitUtil;
import com.exloki.balancedfly.core.utils.Runnables;
import com.exloki.balancedfly.core.utils.Txt;
...
public abstract class CoreCommand implements CommandExecutor, TabCompleter {
     ...
     *
     * The goal of this method should always be conveying an error message to a user in a friendly manner. The {@link com.exloki.balancedfly.core.commands.CommandException} can be extended by your plugin to provide extended functionality.
     *
     ...
     *
     * @param ex The exception used to hold the error message and any other details about the failure. If there was an exception during the handling of the command this will be an {@link com.exloki.balancedfly.core.commands.UnhandledCommandExceptionException}.
    ...
    public BalancedFlyMain getPlugin() {
    ...
    public void setPlugin(Plugin plugin) {
        if(plugin instanceof BalancedFlyMain) {
            this.plugin = (BalancedFlyMain) plugin;
        } else {
            throw new IllegalStateException("plugin must be an instance of " + BalancedFlyMain.class.getName());
        }
    }
