package com.exloki.balancedfly.core.utils;
...
public class JPersist {

    private LPlugin p;
    private File root;

    public JPersist(LPlugin p) {
        this(p, p.getDataFolder());
    }

    public JPersist(LPlugin p, File root) {
        this.p = p;
        this.root = root;
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        ...
        if (loaded == null) {
            p.getLogger().warning("Using default as I failed to load: " + file);
            ...
            p.getLogger().warning("Backing up copy of bad file to: " + backup);
