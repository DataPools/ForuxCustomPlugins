...
import com.exloki.loretransfer.core.utils.Txt;
...
public abstract class LCommand implements ICommand {
    ...
    protected void sendUsage() {
        sender.sendMessage(Msg.ER_USAGE.withVars(getUsage()));
    }
    ...
    protected void sendHelpMessages() {
        ...
        for (StringPair pair : helpMessages) {
    ...
    protected void msg(Msg message, String... vars) {
        sender.sendMessage(message.withVars(vars));
    }
